...
class CorporateLoginForm {
    ...
    validateEmail() {
        ...
        if (!email) {
            this.showError('email', 'É necessário um e-mail');
            return false;
        }
        
        if (!businessEmailRegex.test(email)) {
            this.showError('email', 'Por favor entre com um endereço de e-mail valido');
            return false;
        }
        ...
        if (personalDomains.includes(domain)) {
            this.showError('email', 'Por favor use o seu endereço de e-mail');
            return false;
        }
    ...
    validatePassword() {
        ...
        if (!password) {
            this.showError('password', 'Necessário uma senha');
            return false;
        }
        
        if (password.length < 8) {
            this.showError('password', 'A senha não pode ter menos que 8 caracteres');
            return false;
        }
        ...
        if (!hasUpperCase || !hasLowerCase || !hasNumbers || !hasSpecialChar) {
            this.showError('password', 'A senha precisa ter uma letra maiuscula, minuscula, número, e caracter especial');
            return false;
        }
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            this.showError('password', 'Autenticação falhou. Por favor entre em contato com o ADM da página.');
        } finally {
